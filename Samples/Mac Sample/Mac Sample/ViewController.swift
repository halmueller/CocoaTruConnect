...
class ViewController: NSViewController, CTCManagerDelegate, CTCDeviceDelegate {
	...
	override func viewDidLoad() {
		super.viewDidLoad()
		self.knownDevices = [CTCDevice(), CTCDevice(), CTCDevice()]
	...
	@IBAction func connectToSelectedDevice(_ sender: Any) {
		print(#function)
	}
	...
	@IBAction func quoteTheRaven(_ sender: Any) {
